            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.daplink.runScript(this.getScript_cb(), function (prgs) { return _this.dialog.setProgressValue(prgs); }, function (err) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_k) {
                switch (_k.label) {
                    ...
                    case 4:
                        _k.sent(); // [Ctrl+A] enter raw mode (REPL Python)
                        i = 0;
                        _k.label = 5;
                    case 5:
                    ...
                    case 6:
                        _k.sent();
                        return [4 /*yield*/, ((_d = this.target) === null || _d === void 0 ? void 0 : _d.serialRead())];
                    case 7:
                        _k.sent();
                    ...
                    case 8:
                        ++i;
                        return [3 /*break*/, 5];
                    case 9: return [4 /*yield*/, ((_e = this.target) === null || _e === void 0 ? void 0 : _e.serialWrite("try:\n"))];
                    case 10:
                        _k.sent();
                        return [4 /*yield*/, ((_f = this.target) === null || _f === void 0 ? void 0 : _f.serialWrite("\t__send_script_execution__()\n"))];
                    case 11:
                        _k.sent();
                        return [4 /*yield*/, ((_g = this.target) === null || _g === void 0 ? void 0 : _g.serialWrite("except KeyboardInterrupt:\n"))];
                    case 12:
                        _k.sent();
                        return [4 /*yield*/, ((_h = this.target) === null || _h === void 0 ? void 0 : _h.serialWrite("\tprint(\"--INTERRUPT RUNNING PROGRAM--\")\n\n"))];
                    case 13:
                        _k.sent();
                        return [4 /*yield*/, ((_j = this.target) === null || _j === void 0 ? void 0 : _j.serialWrite(String.fromCharCode(4)))];
                    case 14:
                        _k.sent(); // [Ctrl+D] Start REPL on paste code (REPL Python)
                        return [3 /*break*/, 16];
                    case 15:
                        e_5 = _k.sent();
